      ...
      "meta-ads": {
        ...
        sections: [
            ...
            subSections: [
              {
                ...
                paragraphs: [
                  ...
                  "اگر محتوا، روایت بیمار یا مزیت درمانی روشن داشته باشی، این کانال می‌تواند لیدهای باکیفیتی بسازد."
                ]
              }
            ]
          },
          {
            heading: "روند اجرای کار",
            paragraphs: [
              "در این سرویس شناخت بازار، طراحی محتوا و تحلیل کیفیت لید باید کنار هم جلو بروند. بدون این هماهنگی، کمپین صرفاً خرج می‌کند اما تصویر روشنی از ارزش واقعی نمی‌دهد."
            ],
            subSections: [
              {
              ...
              {
                heading: "مرحله دوم: ساخت محتوا و فرم",
        ...
        faq: [
          ...
          ["آیا بازارهای مختلف را باید جدا اجرا کرد؟", "در اغلب موارد بله. هم زبان، هم پیام و هم محتوا بهتر است برای هر بازار جدا تنظیم شود."]
        ]
      },
      "tiktok-ads": {
        label: "تیک‌تاک ادز",
        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              "نقش این سرویس معمولاً مکمل است؛ یعنی در کنار گوگل یا متا می‌تواند ورودی‌های تازه‌تری به فانل فروش اضافه کند."
            ],
            subSections: [
              {
                heading: "مزیت اصلی تیک‌تاک چیست؟",
                paragraphs: [
                  "سرعت تست محتوا و قدرت ویدیو در جلب توجه مهم‌ترین مزیت این کانال است. اگر پیام برند درست بسته‌بندی شود، می‌توان خیلی سریع‌تر وارد ذهن مخاطب شد."
                ]
              }
            ]
          },
        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              "هدف این است که هیچ لید باکیفیتی بی‌صاحب نماند و مدیر مجموعه بتواند تصویر دقیقی از کل فانل فروش ببیند."
            ],
            subSections: [
              {
